...
abstract class $TaskModelCopyWith<$Res> {
  ...
  $Res call({String id, String title, String body, String isCompleted});
}
...
class _$_TaskModel implements _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskModel(id: $id, title: $title, body: $body, isCompleted: $isCompleted)';
  }
...
abstract class _TaskModel implements TaskModel {
  const factory _TaskModel(
      ...
      required final String isCompleted}) = _$_TaskModel;
